...
function PlaceholderProductImage({ name }: { name: string }) {
    return (
        <div className="w-full h-full bg-gradient-to-br from-blush via-linen to-ivory flex flex-col items-center justify-center">
            <div className="w-20 h-20 rounded-full border-2 border-warm-beige flex items-center justify-center mb-4 opacity-40">
                <Droplets className="w-9 h-9 text-taupe" />
            </div>
