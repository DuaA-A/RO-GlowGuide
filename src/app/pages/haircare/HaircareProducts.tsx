...
export function HaircareProducts() {
    ...
    const [activeType, setActiveType] = useState("All Hair Types");
    ...
    useEffect(() => {
        ...
        if (typeParam) {
            const foundType = hairTypes.find(t => t.id === typeParam);
            setActiveType(foundType ? foundType.name : "All Hair Types");
        } else {
            setActiveType("All Hair Types");
        }
    ...
    const updateFilter = (key: string, value: string | null) => {
        ...
        if (value && value !== "All" && value !== "All Hair Types") {
        ...
        <div className="py-20">
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <SectionHeader
                    ...
                    subtitle="Discover products tailored to your hair pattern and scalp needs."
                />
                ...
                <div className="mt-12 mb-12 flex flex-col items-center gap-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        <span className="w-full text-center text-xs uppercase tracking-widest text-taupe mb-2">Filter by Scalp Concern</span>
                ...
                {/* Filter Summary */}
                {(search || activeCategory !== "All" || activeType !== "All Hair Types" || activeConcern) && (
