                                ...
                                >
                                    <div className="grid md:grid-cols-5 gap-0">
                                        ...
                                        <div className="md:col-span-3 p-8 md:p-10">
                                            <p className="text-xs uppercase tracking-[0.15em] text-taupe mb-1">{hair.pattern}</p>
                                            <h3 className="font-heading text-espresso mb-3">{hair.name}</h3>
                                            <p className="text-mink text-sm leading-relaxed mb-6">{hair.description}</p>
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-sm text-mink leading-relaxed">
                            This information is for educational purposes only. Severe or persistent scalp and hair concerns should be evaluated by a qualified trichologist or dermatologist. Nothing on this platform constitutes professional medical advice.
                        </p>
                    </div>
                </motion.div>
